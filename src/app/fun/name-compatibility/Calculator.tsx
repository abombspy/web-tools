...
export default function Calculator() {
  ...
  return (
    <div className="mt-8 rounded-lg border border-black/10 p-6 dark:border-white/10">
      ...
      {score !== null && (
        <div className="mt-6 space-y-2 border-t border-black/10 pt-6 text-center dark:border-white/10">
          <p className="text-5xl font-bold text-blue-600 dark:text-blue-400">{score}점</p>
