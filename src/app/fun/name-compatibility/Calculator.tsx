...
export default function Calculator() {
  ...
  return (
    <div className="mt-8 rounded-2xl border-2 border-orange-100 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-zinc-900">
      ...
      {score !== null && (
        <div className="mt-6 space-y-2 border-t-2 border-orange-100 pt-6 text-center dark:border-white/10">
          <p className="text-5xl font-bold text-orange-600 dark:text-orange-400">{score}점</p>
