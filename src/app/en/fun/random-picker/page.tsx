...
export const metadata: Metadata = {
  title: "Random Picker & Ladder Game",
  description: "Pick one item at random, shuffle a list, or randomly match participants to outcomes.",
};

export default function RandomPickerPageEn() {
  return (
