...
export default function Calculator() {
  ...
  return (
    <div className="mt-8 rounded-2xl border-2 border-teal-100 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-zinc-900">
      ...
      <textarea
        className="h-48 w-full resize-y rounded-xl border-2 border-zinc-200 p-3 text-sm focus:border-teal-400 focus:outline-none dark:border-white/20 dark:bg-transparent"
        value={text}
